...
- [[API-JavaScript]] — Documentation de `DsCommandPalette`
- [[Livewire-Toast]] — Notifications après exécution de commandes
- [[Installation]] — Intégration globale dans le layout
