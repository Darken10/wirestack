...
> Pour un tableau **interactif** avec recherche, tri et pagination, utilisez [[Livewire-DataTable|`<livewire:ws::data-table>`]].
...
- [[Livewire-DataTable]] — Tableau interactif avec recherche et tri
- [[Composants-Feedback]] — Alert, Progress, EmptyState...
- [[API-JavaScript]] — `DsCopy` pour copier du texte via JS
